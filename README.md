...
- `GET /api/session-context`, `POST /api/session-context/new`, `POST /api/session-context/select`, `POST /api/session-context/rename`, and `POST /api/session-context/delete`: list, create, switch, rename, and delete persisted chat sessions.
