...
- `GET /api/session-context`, `POST /api/session-context/new`, `POST /api/session-context/select`, `POST /api/session-context/rename`, `POST /api/session-context/clear`, and `POST /api/session-context/delete`: list, create, switch, rename, clear visible conversation, and delete persisted chat sessions.
