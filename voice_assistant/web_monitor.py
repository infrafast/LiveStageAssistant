              ...
              <details class="nested-details">
                ...
                <div class="vad-groups">
                  <div class="vad-group" id="speaker-recognition-group">
                    ...
                    <div class="field-hint" title="Exemple à lire: Bonjour, je m'appelle <prénom>. Ceci est un enregistrement de référence pour reconnaître ma voix. Je parle normalement, avec le même micro que j'utiliserai pendant le live. Console, monte un peu ma voix dans mon retour. Régie, baisse légèrement la façade. Régie, coupe le clic dans mon retour, puis fais un fade-out. Je vais maintenant compter calmement: un, deux, trois, quatre, cinq, six, sept, huit, neuf, dix. Cette phrase est dite un peu plus lentement, pour garder quelques sons longs et naturels. Et maintenant une phrase plus courte, comme en situation réelle: régie, augmente ma guitare. Fin de l'enregistrement de référence.">
