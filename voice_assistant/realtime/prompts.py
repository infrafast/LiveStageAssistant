...
- Likewise, do not call a broad health/status tool before a targeted write when the write tool itself provides execution confirmation/readback or otherwise reports verified success/failure. Let the targeted operation establish both execution outcome and live connectivity whenever its MCP contract provides that guarantee.
